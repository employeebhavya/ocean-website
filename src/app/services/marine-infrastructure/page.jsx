...
function MarineInfrastructure() {
  ...
  return (
    <>
      <HeaderInnerServices
        pageTitle="Marine Infrastructure"
        serviceTitle="Marine Infrastructure"
...
export default MarineInfrastructure;
